      ...
      <header>
        <nav>
          <ul>
              ...
              <button onClick={() => navigate("/SignupLogin")}style={{ backgroundColor: 'blue' }}>User Login</button>

              <button  onClick={() => navigate("/ContactUs")} style={{ backgroundColor: 'blue' }}>Contact US</button>
              <button style={{ backgroundColor: 'blue' }}>Offers</button>
...
<nav>
      ...
      <img style={{ height: '150px', width: '100px', }} src="/img/dc2.jpeg" alt="imag not support"/>
      <img style={{ height: '150px', width: '100px', }} src="/img/vaazhai.jpeg" alt="imag not support"/>
      <img style={{ height: '150px', width: '100px', }} src="/img/thangalan.jpeg" alt="imag not support"/>
      <hr/>
      <hr/>
